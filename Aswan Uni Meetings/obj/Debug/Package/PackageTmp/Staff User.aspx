...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function Navigate() {
            javascript: window.open("http://localhost:53620/Staff%20User.aspx", "_self");
        }
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="notification">
                                ...
                                <asp:Label ID="lbltip" class="tool-tip-name" runat="server" data-tooltip="دعوة إجتماع جديد" Visible="false"></asp:Label>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            ...
            <div class="grid-con">
                <asp:GridView ID="GdDoc" CssClass="grid" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GdDoc_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkDownload" runat="server" CommandName="download" CommandArgument='<%# Eval("DetailId") %>' OnCommand="btnSelect_Command"> تنزيل المحضر </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
