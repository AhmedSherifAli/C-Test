...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-user">
        ...
        <div class="main-en">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="notification">
                                <asp:Timer ID="TimerNotif" runat="server" Interval="1000" OnTick="TimerNotif_Tick"></asp:Timer>
            ...
            <div class="grid-con">
                <asp:GridView ID="GdInvitation" CssClass="grid" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GdDoc_SelectedIndexChanged">
                    <Columns>

                        <asp:TemplateField HeaderStyle-CssClass="head" HeaderText="Invitation File">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkDownload" runat="server" CommandName="downinv" OnCommand="btnSelect_Command" PostBackUrl="~/Staff User-EN.aspx"> Download Invitation </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
