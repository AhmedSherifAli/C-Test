        ...
        <div class="main-en">
            ...
            <div class="grid-con">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="head" HeaderText="File Name">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkDownload" runat="server" CommandName="download" CommandArgument='<%# Eval("DetailId") %>' OnCommand="btnSelect_Command">Download File</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
